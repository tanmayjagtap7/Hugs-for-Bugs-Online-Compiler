...
def executePython(code, data):
    with open('home\Compiler\Code Files\python.txt','w') as f:
        f.write(code)
    s = subprocess.run('python "home\Compiler\Code Files\python.txt"', stdin = data, shell = True, capture_output = True)
...
def executeJava(code, data):
    ...
    subprocess.run('javac "F:\GitHub\Hugs-for-Bugs-Online-Compiler\\backend\home\Compiler\Code Files\java.java"', shell = True)
    s = subprocess.run('java "F:\GitHub\Hugs-for-Bugs-Online-Compiler\\backend\home\Compiler\Code Files\java.java"', stdin = data, shell = True, capture_output = True)
...
def executeCpp(code, data):
    ...
    a = subprocess.run('g++ "F:\GitHub\Hugs-for-Bugs-Online-Compiler\\backend\home\Compiler\Code Files\c++.cpp" -o "F:\GitHub\Hugs-for-Bugs-Online-Compiler\\backend\home\Compiler\Code Files\c++.exe"', shell = True)
    s = subprocess.run('"F:\GitHub\Hugs-for-Bugs-Online-Compiler\\backend\home\Compiler\Code Files\c++.exe"', stdin = data, shell = True,  capture_output = True)
